...
class ArtisanMessagesPage extends StatefulWidget {
  const ArtisanMessagesPage({Key? key}) : super(key: key);

  @override
  State<ArtisanMessagesPage> createState() => _ArtisanMessagesPageState();
}

class _ArtisanMessagesPageState extends State<ArtisanMessagesPage> {
  ...
  void initState() {
    ...
    _refreshTimer = Timer.periodic(const Duration(seconds: 10), (_) => _loadConversations());
  }
